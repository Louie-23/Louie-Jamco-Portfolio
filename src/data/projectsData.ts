...
export const projects: Project[] = [
  {
    ...
    link: "https://github.com/Louie-23/THERIS-An-IoT-Based-Thermal-Imaging-Robot-and-Alert-System-for-Search-and-Rescue-Operations-",
  },
  {
    id: 2,
    category: "Prototypes",
    ...
    link: "https://github.com/Louie-23/IoT-Water-Quality-Monitor-using-ESP32",
  },
  {
    id: 3,
    category: "Prototypes",
    ...
    description:
      "A roadside air pollution detection and display system powered by Arduino and a 12864 LCD. The prototype integrates particulate matter (PM), carbon monoxide (CO), carbon dioxide (CO2), and total volatile organic compounds (TVOC) sensors to provide real-time air quality data. Designed to raise public awareness and promote healthier environments through accessible roadside monitoring.",
    ...
    link: "https://github.com/Louie-23/Roadside-Air-Pollution-Detection-using-Arduino-and-12864-LCD",
  },
  {
    id: 4,
    category: "Prototypes",
    ...
    link: "https://github.com/Louie-23/Automatic-Obstacle-Avoidance-Car-with-Manual-IR-Remote-Control-using-Arduino",
  },
  {
    id: 5,
    category: "Software",
    ...
    images: [
      "SoftwareA/SoftwareA2.webp",
      "SoftwareA/SoftwareA3.webp",
      "SoftwareA/SoftwareA4.webp",
      "SoftwareA/SoftwareA12.webp",
      "SoftwareA/SoftwareA5.webp",
      "SoftwareA/SoftwareA6.webp",
      "SoftwareA/SoftwareA7.webp",
      "SoftwareA/SoftwareA8.webp",
      "SoftwareA/SoftwareA9.webp",
    ],
    videos: ["SoftwareA/SoftwareA10.mp4", "SoftwareA/SoftwareA11.mp4"],
    link: "https://github.com/Louie-23/Barangay-Inventory-Management-System-using-C--and-MicrosoftSQL",
  },
  {
    id: 6,
    category: "Software",
  ...
  },
  {
    ...
    link: "https://github.com/Louie-23/CPU-Scheduling-Shortest-Remaining-Time-First-Calculator-using-C--",
  },
  {
    id: 8,
    category: "Software",
